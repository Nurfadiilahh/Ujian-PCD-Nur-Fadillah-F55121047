...
def show_creator():
    creator_label = tk.Label(root, text='Nama : Nur Fadilah   | NIM : F55121047   | Kelas : B  | Jurusan : Teknologi Informasi | Prodi : Teknik Informatika | Fakultas : Teknik ')
    creator_label.place(x=140, y=480)
